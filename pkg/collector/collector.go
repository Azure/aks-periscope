...
const (
	...
	NetworkOutbound
	// OnDemandLogs defines OnDemandLogs Collector Type
	OnDemandLogs
...
func (t Type) name() string {
	return [...]string{"dns", "containerlogs", "iptables", "kubeletcmd", "kubeobjects", "networkoutbound", "ondemandlogs", "systemlogs", "systemperf"}[t]
}
